...
"""
isowplot = isow.plots.PlotISOW(start, end)    # Initiate the "plot" class

isowplot.summary()                            # Time-series of the simulated ISOW vs forcings
isowplot.shap_summary()                       # Violin plots of SHAP values
isowplot.shap_bars()                          # Histograms of mean absolute SHAP values
isowplot.shap_time_series()                   # Time-series of SHAP values
isowplot.shap_dependance()                    # Dependance plots of the SHAP values
